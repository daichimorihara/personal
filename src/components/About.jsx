...
const About = () => {
  return (
    <div name='about' className='w-full h-screen bg-[#f5f2f2] text-black'>
      {/* Container */}
      <div className='max-w-[600px] mx-auto px-8 flex flex-col justify-center h-full object-center'>
        ...
        <p className='text-left text-xl pb-6'>Highly motivated Junior Front-End Developer with a strong skill set in HTML,
